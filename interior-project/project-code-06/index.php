...
<!-- Mirrored from paul-themes.com/html/intria/intria-demo/intria/dark/project-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Nov 2020 10:07:55 GMT -->
    ...
    <div class="layout animsition">
        ...
        <div class="side_menu dark_s_menu">
            ...
            <ul class="menu-list right-boxed">
                <li>
                    ...
                    <ul class="list">
                        <li><a href="http://paul-themes.com/html/intria/intria-demo/intria/light/index.html">Default</a></li>
                        <li><a href="index.html">Default Dark</a></li>
                        <li><a href="http://paul-themes.com/html/intria/intria-demo/intria/light/home-fullpage.html">Parallax</a></li>
                        <li><a href="home-fullpage.html">Parallax Dark</a></li>
                    </ul>
                </li>
                <li><a href="about-us.html">Studio</a></li>
                <li class="active">
        ...
        <header class="header_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.html"><img src="img/logo.png" alt=""><img src="img/logo-dark.png" alt=""></a>
            ...
            <div class="container">
                <div class="breadcrumb_inner">
                    <div class="breadcrumb_link">
                        <a href="#">interior - Architecture</a>
                    </div>
                    <div class="bread_bottom_text">
                        <h2>edden’s Villa<br /> Private Residence</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="pd_item">
                            <h5>Location: <span>Calle Blancos, San José, Costa Rica</span></h5>
                            <h5>Client: <span>Edden Roseph Jr</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="pd_item">
                            <h5>Completed: <span>January 2018</span></h5>
                            <h5>Architect: <span>Rob Kenny</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="pd_item">
        ...
        <section class="project_villa_area">
            <div class="container">
                <div class="villa_text">
                    <h2>Edden’s Villa</h2>
                    <p>Edden’s Villa is an international project located in Costa Rica. It has various different levels, whom are embedded into the unevenness of the terrain. This project seeks to integrate passive strategies for energy saving, such as the inclusion of as much natural light as possible as well as having green roofs with lots of vegetation in them. The geometry of this house combines design with nature into the structure of the house, which makes it unique amongst other neighboring places.</p>
                </div>
                <div class="villa_slider owl-carousel">
                    <div class="item">
                        <img src="img/latest-project/project-s-1.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="img/latest-project/project-s-1.jpg" alt="">
                    </div>
        ...
        <footer class="footer_area">
            <div class="footer_widgets row m0">
                ...
                <aside class="f_widgets_item">
                    <div class="f_contact">
                        ...
                        <p>17 Princess Road, London, Greater London, NW18JR, United Kingdom</p>
                        <a href="http://paul-themes.com/cdn-cgi/l/email-protection#3058555c5c5f70595e44554243444554595f1e535f"><span class="__cf_email__" data-cfemail="7119141d1d1e31181f05140302050415181e5f121e">[email&#160;protected]</span></a>
                        <a href="tel:9123548073">(+0084) 912-3548-073</a>
                    </div>
                </aside>
                <aside class="f_widgets_item">
                    <div class="f_link">
            ...
            <div class="footer_copyright">
                <div class="left_text">
                    <p>©2018 <a href="#">Intria</a>. All Rights Reserved</p>
                </div>
...
<!-- Mirrored from paul-themes.com/html/intria/intria-demo/intria/dark/project-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Nov 2020 10:07:59 GMT -->
